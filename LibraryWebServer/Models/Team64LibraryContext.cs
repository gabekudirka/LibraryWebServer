...
{
    public partial class Team64LibraryContext : DbContext
    {
        public Team64LibraryContext()
        {
        }

        public Team64LibraryContext(DbContextOptions<Team64LibraryContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseMySql("Server=atr.eng.utah.edu;User Id=u1216377;Password=Gabe621356;Database=Team64Library");
            }
        }
